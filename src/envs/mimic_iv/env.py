...
from src.envs.mimic_iv_star.tools.value_similarity_search import (
    ValueSimilaritySearch,
)
from src.envs.mimic_iv_star.tools.value_substring_search import (
...
class MimicIVEnv(Env):
    def __init__(
        ...
        db_id: str = "mimic_iv",
        db_path: str = "data/mimic_iv.sqlite",
        ...
        verify_original_database(db_path, DatabaseSchema.MIMIC_IV)
