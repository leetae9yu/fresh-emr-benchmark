# IncreQA SQL-only interim report
...
- 768 valid trajectories
- 70 physical checkpoint files
- 0 malformed JSONL files
- 0 incomplete latest checkpoints
- Every latest checkpoint has 12 valid rows, 3 per task
- `OPENROUTER_API_KEY_2` was absent from worker environments
- No embedding-mode process was started
